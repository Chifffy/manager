		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 0 30px"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"10px","borderRadius":"3px","background":"#fff","display":"block"}' >
					...
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
						...
						<el-input v-model="searchForm.xingbie" placeholder="性别" clearable></el-input>
					</div>
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#666","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">年级班级</label>
						<el-input v-model="searchForm.nianjibanji" placeholder="年级班级" clearable></el-input>
					</div>
				...
				<el-row :style='{"margin":"20px 0 20px 0","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"rgba(64, 158, 255, 1)","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('zhiyuanzhebaoming','新增')" type="success" @click="addOrUpdateHandler()">新增</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"rgba(255, 0, 0, 1)","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('zhiyuanzhebaoming','删除')" :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandler()">删除</el-button>
			...
			<!-- <div> -->
				<el-table class="tables"
					...
					v-if="isAuth('zhiyuanzhebaoming','查看')"
					:data="dataList"
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='true' prop="gerenjianjie" label="个人简介">
						<template slot-scope="scope">
							<el-button v-if="scope.row.gerenjianjie" type="text" size="small" @click="download($base.url+scope.row.gerenjianjie)">下载</el-button>
                            <span v-else >无</span>
						</template>
					</el-table-column>
					...
					<el-table-column :resizable='true' :sortable='true' v-if="isAuth('zhiyuanzhebaoming','审核')" prop="sfsh" label="审核">
						<template slot-scope="scope">
      ...
      let params = {
        ...
        order: 'desc',
          ...
          if(this.searchForm.sfsh!='' && this.searchForm.sfsh!=undefined){
           ...
           if(this.searchForm.nianjibanji!='' && this.searchForm.nianjibanji!=undefined){
            params['nianjibanji'] = '%' + this.searchForm.nianjibanji + '%'
          }
          if(this.searchForm.sfsh!='' && this.searchForm.sfsh!=undefined){
            params['sfsh'] = this.searchForm.sfsh
          }
    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
          ...
          nianjibanji: row.nianjibanji,
          zhengjianhaoma: row.zhengjianhaoma,
