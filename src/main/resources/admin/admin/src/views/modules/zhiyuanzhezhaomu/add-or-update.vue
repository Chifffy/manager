<template>
	<div class="addEdit-block" :style='{"padding":"10px 30px 30px","background":"url(http://codegen.caihongy.cn/20230228/47752d6be3a94e8892a83ec2a70c8443.png)"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="招募编号" prop="zhaomubianhao">
					<el-input v-model="ruleForm.zhaomubianhao" placeholder="招募编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.zhaomubianhao" label="招募编号" prop="zhaomubianhao">
					<el-input v-model="ruleForm.zhaomubianhao" placeholder="招募编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="人数" prop="renshu">
					<el-input v-model="ruleForm.renshu" placeholder="人数" clearable  :readonly="ro.renshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="人数" prop="renshu">
					<el-input v-model="ruleForm.renshu" placeholder="人数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="工作时间" prop="gongzuoshijian">
					<el-input v-model="ruleForm.gongzuoshijian" placeholder="工作时间" clearable  :readonly="ro.gongzuoshijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="工作时间" prop="gongzuoshijian">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="要求" prop="yaoqiu">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.yaoqiu" label="要求" prop="yaoqiu">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.yaoqiu}}</span>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="招募详情" prop="zhaomuxiangqing">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.zhaomuxiangqing" label="招募详情" prop="zhaomuxiangqing">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.zhaomuxiangqing"></span>
                </el-form-item>
...
export default {
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='zhaomubianhao'){
							this.ruleForm.zhaomubianhao = obj[o];
							this.ro.zhaomubianhao = true;
							continue;
						}
						if(o=='biaoti'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.zhaomuxiangqing = this.ruleForm.zhaomuxiangqing.replace(reg,'../../../springboot7cox6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zhiyuanzhezhaomu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zhiyuanzhezhaomuCrossAddOrUpdateFlag = false;
						 this.parent.search();
