    ...
    <el-tabs tab-position="left" :style='{"alignItems":"center","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","position":"relative","justifyContent":"center"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="120px">
          <el-form-item :style='{"border":"3px solid #c6ecc6","padding":"10px","margin":"0 0 10px","background":"#fff"}' v-if="userTableName=='bumenguanliyuan'" label="账号" prop="zhanghao">
            <el-input v-model="sessionForm.zhanghao" placeholder="账号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"3px solid #c6ecc6","padding":"10px","margin":"0 0 10px","background":"#fff"}' v-if="userTableName=='bumenguanliyuan'" label="昵称" prop="nicheng">
            <el-input v-model="sessionForm.nicheng" placeholder="昵称" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"3px solid #c6ecc6","padding":"10px","margin":"0 0 10px","background":"#fff"}' v-if="userTableName=='bumenguanliyuan'" label="密码" prop="mima">
            <el-input type="password" v-model="sessionForm.mima" placeholder="密码"></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"3px solid #c6ecc6","padding":"10px","margin":"0 0 10px","background":"#fff"}' v-if="userTableName=='bumenguanliyuan'" label="电话" prop="dianhua">
            <el-input v-model="sessionForm.dianhua" placeholder="电话" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"3px solid #c6ecc6","padding":"10px","margin":"0 0 10px","background":"#fff"}' v-if="userTableName=='bumenguanliyuan'" label="头像">
            <el-upload
              class="avatar-uploader"
              :action="uploadUrl"
              :headers="headers"
              :show-file-list="false"
              :on-success="bumenguanliyuantouxiangHandleAvatarSuccess">
          ...
          <el-form-item :style='{"border":"3px solid #c6ecc6","padding":"10px","margin":"0 0 10px","background":"#fff"}' v-if="userTableName=='xuesheng'" label="账号" prop="zhanghao">
            <el-input v-model="sessionForm.zhanghao" placeholder="账号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"3px solid #c6ecc6","padding":"10px","margin":"0 0 10px","background":"#fff"}' v-if="userTableName=='xuesheng'" label="姓名" prop="xingming">
          ...
          <el-form-item :style='{"border":"3px solid #c6ecc6","padding":"10px","margin":"0 0 10px","background":"#fff"}' v-if="userTableName=='xuesheng'" label="联系电话" prop="lianxidianhua">
            <el-input v-model="sessionForm.lianxidianhua" placeholder="联系电话" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"3px solid #c6ecc6","padding":"10px","margin":"0 0 10px","background":"#fff"}' v-if="userTableName=='xuesheng'" label="学院" prop="xueyuan">
            <el-input v-model="sessionForm.xueyuan" placeholder="学院" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"3px solid #c6ecc6","padding":"10px","margin":"0 0 10px","background":"#fff"}' v-if="userTableName=='xuesheng'" label="年级班级" prop="nianjibanji">
            <el-input v-model="sessionForm.nianjibanji" placeholder="年级班级" ></el-input>
          </el-form-item>
...
<script>
  ...
  export default {
    ...
    created() {
      if ('bumenguanliyuan' == this.userTableName) {
      ...
      if ('xuesheng' == this.userTableName) {
        this.$set(this.sessionForm, 'nianjibanji', null);
      }
    ...
    methods: {
      ...
      bumenguanliyuantouxiangHandleAvatarSuccess(res, file) {
        if (res.code == 0) {
          if ('bumenguanliyuan' == this.userTableName) {
