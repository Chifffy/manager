...
<div>
	...
	<div class="detail-preview" :style='{"width":"100%","padding":"10px 7% 20px","margin":"0px auto 0","position":"relative","background":"none"}'>
		<div class="attr" :style='{"border":"1px solid #ddd","minHeight":"620px","padding":"10px 0 0px 0px","boxShadow":"0px 0px 4px #eee","overflow":"hidden","flexWrap":"wrap","background":"rgba(255,255,255,1)","display":"flex","position":"relative","justifyContent":"space-between"}'>
			...
			<div class="zancai" :style='{"padding":"0","margin":"0","top":"500px","background":"#fff","display":"flex","width":"48%","position":"absolute","right":"20px","justifyContent":"space-between","order":"3"}'>
				<div :style='{"border":"3px solid #c6ecc6","padding":"10px 0","margin":"0","alignItems":"center","borderRadius":"20%","background":"#fff","display":"flex","width":"150px","justifyContent":"center"}' v-if="!isThumbsupnum && !isCrazilynum" class="zan" @click="thumbsupOrCrazily(21)">
				...
				<div :style='{"border":"3px solid #c6ecc6","padding":"10px 0","margin":"0","alignItems":"center","borderRadius":"20%","background":"#fff","display":"flex","width":"150px","justifyContent":"center"}' v-if="!isThumbsupnum && !isCrazilynum" class="cai" @click="thumbsupOrCrazily(22)">
				...
				<div :style='{"border":"3px solid #c6ecc6","padding":"10px 0","margin":"0","alignItems":"center","borderRadius":"20%","background":"#fff","display":"flex","width":"150px","justifyContent":"center"}' v-if="isThumbsupnum" class="zan" @click="cancelThumbsupOrCrazily(21)">
					<i :style='{"color":"#666","margin":"0 3px","fontSize":"14px"}' class="iconfont icon-dianzan"></i>
					<span :style='{"color":"#666","margin":"0 3px","fontSize":"14px"}'>取消赞({{detail.thumbsupnum}})</span>
				</div>
				<div :style='{"border":"3px solid #c6ecc6","padding":"10px 0","margin":"0","alignItems":"center","borderRadius":"20%","background":"#fff","display":"flex","width":"150px","justifyContent":"center"}' v-if="isCrazilynum" class="cai" @click="cancelThumbsupOrCrazily(22)">
					<i :style='{"color":"#666","margin":"0 3px","fontSize":"14px"}' class="iconfont icon-iconfontzan"></i>
			...
			<div class="info" :style='{"minHeight":"500px","width":"48%","padding":"10px 10px 10px 20px","margin":"0","background":"none"}'>
				...
				<div class="item" :style='{"padding":"0","margin":"0 0 15px 0","borderColor":"#c6ecc6","borderWidth":"0px 0px 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","background":"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"102px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>招募编号</div>
					<div  :style='{"width":"498px","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5"}'>{{detail.zhaomubianhao}}</div>
				</div>
				<div class="item" :style='{"padding":"0","margin":"0 0 15px 0","borderColor":"#c6ecc6","borderWidth":"0px 0px 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","background":"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"102px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>要求</div>
					<div  :style='{"width":"498px","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5"}'>{{detail.yaoqiu}}</div>
				</div>
				<div class="item" :style='{"padding":"0","margin":"0 0 15px 0","borderColor":"#c6ecc6","borderWidth":"0px 0px 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","background":"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"102px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>人数</div>
					<div  :style='{"width":"498px","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5"}'>{{detail.renshu}}</div>
				</div>
				<div class="item" :style='{"padding":"0","margin":"0 0 15px 0","borderColor":"#c6ecc6","borderWidth":"0px 0px 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","background":"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"102px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>工作时间</div>
					<div  :style='{"width":"498px","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5"}'>{{detail.gongzuoshijian}}</div>
				</div>
				<div class="item" :style='{"padding":"0","margin":"0 0 15px 0","borderColor":"#c6ecc6","borderWidth":"0px 0px 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","background":"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"102px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>工作地点</div>
					<div  :style='{"width":"498px","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5"}'>{{detail.gongzuodidian}}</div>
				</div>
				<div class="item" :style='{"padding":"0","margin":"0 0 15px 0","borderColor":"#c6ecc6","borderWidth":"0px 0px 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","background":"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"102px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>截止时间</div>
					<div  :style='{"width":"498px","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5"}'>{{detail.jiezhishijian}}</div>
				</div>
				<div class="item" :style='{"padding":"0","margin":"0 0 15px 0","borderColor":"#c6ecc6","borderWidth":"0px 0px 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","background":"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"102px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>发布日期</div>
					<div  :style='{"width":"498px","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5"}'>{{detail.faburiqi}}</div>
				</div>
				<div class="item" :style='{"padding":"0","margin":"0 0 15px 0","borderColor":"#c6ecc6","borderWidth":"0px 0px 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
				...
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#333","borderRadius":"4px","background":"#e1effa","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="isAuth('zhiyuanzhezhaomu','报名')" @click="onAcross('zhiyuanzhebaoming','','','')" type="warning">报名</el-button>
				</div>
			</div>
  ...
  export default {
    ...
    methods: {
      ...
      onAcross(acrossTable,crossOptAudit,statusColumnName,tips,statusColumnValue){
        localStorage.setItem('crossTable',`zhiyuanzhezhaomu`);
      ...
      storeup(type) {
        ...
        if (type == -1 && this.isStoreup) {
          this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 1, refid: this.detail.id, tablename: 'zhiyuanzhezhaomu', userid: localStorage.getItem('userid')}}).then(res => {
      ...
      thumbsupOrCrazily(type) {
        ...
        this.$http.post('zhiyuanzhezhaomu/update', this.detail).then(res => {});
      },
    ...
    getThumbsupOrCrazilyStatus() {
        if(localStorage.getItem("Token")) {
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 21, refid: this.detail.id, tablename: 'zhiyuanzhezhaomu', userid: localStorage.getItem('userid')}}).then(res => {
              if (res.data.code == 0 && res.data.data.list.length > 0) {
            ...
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 22, refid: this.detail.id, tablename: 'zhiyuanzhezhaomu', userid: localStorage.getItem('userid')}}).then(res => {
              if (res.data.code == 0 && res.data.data.list.length > 0) {
      ...
      getDiscussList(page) {
        this.$http.get('discusszhiyuanzhezhaomu/list', {params: {page, limit: this.pageSize, refid: this.detail.id}}).then(res => {
          if (res.data.code == 0) {
      ...
      submitForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            this.$http.post('discusszhiyuanzhezhaomu/add', this.form).then(res => {
              if (res.data.code == 0) {
                this.form.content = '';
                this.getDiscussList(1);
                this.$message({
